...
public class Task {
    ...
    public void dumpTask() {
        try {
            Tyrone.say(String.format("Name: %s%nStart: %d%nEnd: %d%nUsername: %s%nTaskID: %d%nProgress: %s%n", this.name, this.start, this.end, this.USER, this.taskID, this.getProgress()));
        }catch (Exception e){
    ...
    public void displayTask(){
        try {
            ...
            Tyrone.say(String.format("Name: %s%nStart: %s%nEnd: %s%nUsername: %s%nTaskID: %d%nProgress: %s%n", this.name, epochToStringDate(this.start), epochToStringDate(this.end), this.USER, this.taskID, this.getProgress()));
        }catch (Exception e){
            System.err.println("err [!!] failed to display Task");
            e.printStackTrace();
        }
    }
    ...
    private String epochToStringDate(long epochTime){
